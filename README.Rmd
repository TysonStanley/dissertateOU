...
The goal of `dissertateOU` is to make two aspects of writing a dissertation at Oklahoma University better:
...
We also want to thank the [`rticles`](https://github.com/rstudio/rticles) package for the functionality for `dissertateOU`. The idea to make this package, as well as its design, was derived from the `rticles` package.
