...
#'
#' @export
dissertateOU <- function(..., highlight = NULL, citation_package = "none") {

  # Find template in dissertateOU
  template_file <-
    system.file("rmarkdown", "templates", "dissertateOU",
                file.path("resources", "template.tex"),
                package = "dissertateOU")
