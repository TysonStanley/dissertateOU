...
\renewcommand{\maketitle}{
	...
	\MakeUppercase{University of Oklahoma \\ Graduate College}
	\vspace{30pt}

	\MakeUppercase{$title$}\\

	\MakeUppercase{A thesis \\ submitted to the graduate faculty} \\
	\doublespaced
  ...
  \MakeUppercase{$title$}\\
	\MakeUppercase{A dissertation approved for the \\ $academicunit$}
...
\renewcommand{\maketitle}{
	...
	\MakeUppercase{A dissertation \\ submitted to the graduate faculty} \\
	\doublespaced
	in partial fulfillment of the requirements for the \\
	Degree of\\
	\MakeUppercase{$degree$} \\
